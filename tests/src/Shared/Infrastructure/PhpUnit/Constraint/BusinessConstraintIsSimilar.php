...
use LuisCusihuaman\Tests\Shared\Infrastructure\PhpUnit\Comparator\DomainEventArraySimilarComparator;
use LuisCusihuaman\Tests\Shared\Infrastructure\PhpUnit\Comparator\DomainEventSimilarComparator;
...
final class BusinessConstraintIsSimilar extends Constraint
{
    private $value;
    private $delta;
