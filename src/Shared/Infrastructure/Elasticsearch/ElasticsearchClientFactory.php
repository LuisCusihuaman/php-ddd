...
namespace LuisCusihuaman\Shared\Infrastructure\Elasticsearch;
...
{
    public function __invoke(string $host, string $indexPrefix,
                             string $schemasFolder, string $environment): ElasticsearchClient
    {
    ...
    private function generateIndexIfNotExists(
        Client $client, string $indexPrefix, string $schemasFolder, $environment): void
    {
